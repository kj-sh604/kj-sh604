...
## self intro 👤
I am a passionate software engineer with recent experience and expertise in the FinTech industry. In my spare time, I enjoy building minimalist software for GNU/Linux and UNIX-like systems. I am also very much enthused with developing useful web applications 🌐.
...
- **[⌚ dateTimeSetter](https://aedrielkylejavier.me/scripts-and-tools/datetimesetter/):** Functional GUI for systemd's `timedatectl` written in python & tk. Useful for standalone window managers on GNU/Linux.
- **[🎧 playerctl_systray](https://aedrielkylejavier.me/scripts-and-tools/playerctl_systray/):** A minimal system tray applet for `playerctl`.
- **[🍅 posix-pomo](https://aedrielkylejavier.me/scripts-and-tools/posix-pomo/):** POSIX-compliant shell script that implements a CLI pomodoro timer.
- **[📜 pandoc-résumé](https://github.com/kj-sh604/pandoc-resume):** Create your résumé easily with a single markdown file.

I have smaller projects that you can find in the [script & tools](https://aedrielkylejavier.me/scripts-and-tools/) section of my [website](https://aedrielkylejavier.me/). Feel free to explore my Github repos as well! 🐱
...
- **Work Environments:** Experienced in Agile methodologies (Scrum, Kanban)
...
- **[🖌️ kj_shugo](https://github.com/kj-sh604/kj_shugo):** my VERY minimal Hugo theme that I use on my [blog](https://aedrielkylejavier.me/articles/) and [scripts/tools](https://aedrielkylejavier.me/scripts-and-tools/) sites.
